...
private void InitTable(){//inisiasi tabel atau membuat table secara manual
   ...
   private boolean validasi(String judul){ //mthod agar tidk ada data yang sama ketika dibuat
    ...
    private void initComponents() {
        ...
        penulis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Eiichiro Oda ", "Hideaki Sorachi", "Akira Toriyama", "Masashi Kishimoto", "Gosho Aoyama", "Takeshi Konomi", "Fujiko F. Fujio" }));
